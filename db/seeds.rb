...
usuario_bancario         = User.new( email: 'empleado@gmail.com'  , password: '123456789' , password_confirmation: '123456789' , name: 'bancario'    , role: 2, subsidiary: sucursal_83)
usuario_bancario_2       = User.new( email: 'empleado2@gmail.com' , password: '123456789' , password_confirmation: '123456789' , name: 'bancario2'   , role: 2, subsidiary: sucursal_79)
usuario_cliente          = User.new( email: 'cliente@gmail.com'   , password: '123456789' , password_confirmation: '123456789' , name: 'cliente')
...
turno_2   = Turn.new(turn_date: fecha_2022_diciembre_20  , hour: tiempo_once_mañana       , reason_turn: "Pedido de factura"           , subsidiary: sucursal_111  , state: 'Atendido'   , user_client: usuario_cliente      , user_bank: usuario_bancario)
...
turno_6   = Turn.new(turn_date: fecha_2022_diciembre_26  , hour: tiempo_once_mañana       , reason_turn: "Vencimiento de la tarjeta"   , subsidiary: sucursal_111  , state: 'Atendido'   , user_client: usuario_cliente_2    , user_bank: usuario_bancario)
...
turno_8   = Turn.new(turn_date: fecha_2022_octubre_2     , hour: tiempo_doce_mañana       , reason_turn: "Horarios de atencion cortos" , subsidiary: sucursal_83   , state: 'Atendido'   , user_client: usuario_cliente_2    , user_bank: usuario_bancario_2)
...
turno_11  = Turn.new(turn_date: fecha_2022_diciembre_19  , hour: tiempo_dieciseis_tarde   , reason_turn: "Cambio de contraseñas"       , subsidiary: sucursal_111  , state: 'Atendido'   , user_client: usuario_cliente_3    , user_bank: usuario_bancario_2)
