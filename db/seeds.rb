...
turno_2   = Turn.new(turn_date: fecha_2022_diciembre_20  , hour: tiempo_once_mañana       , reason_turn: "Pedido de factura"           , subsidiary: sucursal_111  , state: 'Atendido'   , user_client: usuario_client    , user_bank: usuario_bank)
...
turno_6   = Turn.new(turn_date: fecha_2022_diciembre_26  , hour: tiempo_once_mañana       , reason_turn: "Vencimiento de la tarjeta"   , subsidiary: sucursal_111  , state: 'Atendido'   , user_client: usuario_client    , user_bank: usuario_bank)
...
turno_8   = Turn.new(turn_date: fecha_2022_octubre_2     , hour: tiempo_doce_mañana       , reason_turn: "Horarios de atencion cortos" , subsidiary: sucursal_83   , state: 'Atendido'   ,  user_client: usuario_client   , user_bank: usuario_bank)
...
turno_11  = Turn.new(turn_date: fecha_2022_diciembre_19  , hour: tiempo_dieciseis_tarde   , reason_turn: "Cambio de contraseñas"       , subsidiary: sucursal_111  , state: 'Atendido'   , user_client: usuario_client_2  , user_bank: usuario_bank)
