...
turno_2   = Turn.new(turn_date: dia_mes_anio_2022_diciembre_20, hour: '11:00', reason_turn: "Pedido de factura"           , subsidiary: sucursal_111  , state: 'Atendido', user_client: usuario_client)
...
turno_6   = Turn.new(turn_date: dia_mes_anio_2022_diciembre_26, hour: '11:00', reason_turn: "Vencimiento de la tarjeta"   , subsidiary: sucursal_111  , state: 'Atendido', user_client: usuario_client)
...
turno_11  = Turn.new(turn_date: dia_mes_anio_2022_diciembre_19, hour: '16:00', reason_turn: "Cambio de contraseñas"       , subsidiary: sucursal_111  , state: 'Atendido', user_client: usuario_client_2)
